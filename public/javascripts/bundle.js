...
var getAlert = function getAlert() {
	console.log("Here is Console Message!!");
};
getAlert();

'use strict';
var roles = new Map([['r1', 'name'], ['r2', 'ahsan'], ['r3', 'munir']]);
var _iteratorNormalCompletion = true;
var _didIteratorError = false;
var _iteratorError = undefined;

try {
	for (var _iterator = roles.entries()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
		var r = _step.value;
...
function getCar(make, model, value) {
	...
	return _ref = {
		...
		value: value }, _defineProperty(_ref, 'make' + make, true), _defineProperty(_ref, "depreciate", function depreciate() {
		this.value -= 2500;
	}), _ref;
}
...
var eventCardInfo = {
    ...
    title = eventCardInfo.title,
    url = eventCardInfo.url,
    tagline = eventCardInfo.tagline,
    tags = eventCardInfo.tags,
...

	{
		...
		var InheritanceError = function (_Error) {
			...
			function InheritanceError() {
				...
				return _possibleConstructorReturn(this, (InheritanceError.__proto__ || Object.getPrototypeOf(InheritanceError)).apply(this, arguments));
			}
		...
		var Note = function () {
			...
			_createClass(Note, [{
				...
				value: function add() {
					...
					var note = new (Function.prototype.bind.apply(this, [null].concat([id], properties)))();
		...
		var ColorNote = function (_Note) {
			...
			function ColorNote(id, content, owner) {
				...
				var _this2 = _possibleConstructorReturn(this, (ColorNote.__proto__ || Object.getPrototypeOf(ColorNote)).call(this, id, content, owner));
			...
			_createClass(ColorNote, [{
				...
				value: function toString() {
					...
					// first
					return _get(ColorNote.prototype.__proto__ || Object.getPrototypeOf(ColorNote.prototype), "toString", this).call(this) + "\n\t\t\t\t\tColor: " + this._color;
				}
			}, {
				key: "color",
				get: function get() {
